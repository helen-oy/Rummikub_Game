...
def gameover(winner):
    ...
    while True:
        ...
        # quit button
        gameover_quit = Button(image=pygame.image.load("rectQUIT.png"), pos=(550, 550), text_input="QUIT",
                               font=get_font(50), base_color=(240, 0, 50), hovering_color="white")
        ...
        if winner == "computer_player":
            ...
            gameover_text = font.render("GAME OVER !!!")
            congrats_text = get_font(60).render("It's a draw! Do you want to play again? Return to main menu", True,
                                                (255, 211, 155))
